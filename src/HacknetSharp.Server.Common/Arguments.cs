...
// Modifications: added nullable support
...
namespace HacknetSharp.Server.Common
{
    ...
    public class Arguments
    {
        ...
        {
            StringBuilder translatedArguments = new StringBuilder(commandLine);
            bool escaped = false;
            ...
            string[] toReturn = translatedArguments.ToString()
        ...
        public static string RemoveMatchingQuotes(string stringToTrim)
        {
            ...
            while (firstQuoteIndex != lastQuoteIndex)
            {
                ...
                stringToTrim =
                    stringToTrim.Remove(lastQuoteIndex - 1, 1); //-1 because we've shifted the indicies left by one
        ...
        {
            get { return _parameters.ContainsKey(parameter) ? _parameters[parameter] : null; }
        }
    }
}
